    ...
    public static void main(String[] args) {
        Page page = new PageTemplate.Builder()
            ...
            .add(p1 -> new ImmutableStackingContainer.Builder()
                .setMinimumSize(p1.getMinimumSize())
                .doOnClick(e -> System.out.println("StackingContainer - Click!"))
                .add(p2 -> new ImmutableRatioContainer.Builder()
                    .setFixedSize(p2.getMinimumSize())
                    .add(new ImmutableStackingContainer.Builder().build(), 1)
                    .add(new ImmutableStackingContainer.Builder().build(), 3)
                    .doOnCreate(element -> {
